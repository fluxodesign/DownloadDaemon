		...
		try {
			...
			while (jTorrentIterator hasNext) {
				...
				if ((jTorrentObject get "quality") equals "720p") {
					...
					movie.TorrentSeeds720p_=((jTorrentObject get "seeds").asInstanceOf[Long].toInt)
					movie.TorrentPeers720p_=((jTorrentObject get "peers").asInstanceOf[Long].toInt)
					...
					movie.TorrentSeeds1080p_=((jTorrentObject get "seeds").asInstanceOf[Long].toInt)
					movie.TorrentPeers1080p_=((jTorrentObject get "peers").asInstanceOf[Long].toInt)
					...
					movie.TorrentSeeds3D_=((jTorrentObject get "seeds").asInstanceOf[Long].toInt)
					movie.TorrentPeers3D_=((jTorrentObject get "peers").asInstanceOf[Long].toInt)
